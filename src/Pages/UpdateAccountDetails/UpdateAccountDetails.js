...
const UpdateAccountDetails = () => {
  ...
  //  const [value, setValue] = useState();
   ...
   const handleTitleChange = e => {
    ...
    const updatedUser = { title: updatedTitle, firstName: userInfoFromDB.firstName, lastName: userInfoFromDB.lastName, phone: userInfoFromDB.phone, location: userInfoFromDB.location, image: userInfoFromDB.image };
    setUserInfoFromDB(updatedUser);
  }
   const handleFirstNameChange = e => {
    const updatedFirstName = e.target.value;
    const updatedUser = { title: userInfoFromDB.title, firstName: updatedFirstName, lastName: userInfoFromDB.lastName, phone: userInfoFromDB.phone, location: userInfoFromDB.location, image: userInfoFromDB.image };
    setUserInfoFromDB(updatedUser);
  }
   const handleLastNameChange = e => {
    const updatedLastName = e.target.value;
    const updatedUser = { title: userInfoFromDB.title, firstName: userInfoFromDB.firstName, lastName: updatedLastName, phone: userInfoFromDB.phone, location: userInfoFromDB.location, image: userInfoFromDB.image };
    setUserInfoFromDB(updatedUser);
  }
  ...
  // }
   ...
   const handleLocationChange = e => {
    ...
    const updatedUser = { title: userInfoFromDB.title, firstName: userInfoFromDB.firstName, lastName: userInfoFromDB.lastName, phone: userInfoFromDB.phone, location: updatedLocation, image: userInfoFromDB.image };
    setUserInfoFromDB(updatedUser);
  }
   const handleImageChange = e => {
    const updatedImage = (e.target.files[0]);
    const updatedUser = { title: userInfoFromDB.title, firstName: userInfoFromDB.firstName, lastName: userInfoFromDB.lastName, phone: userInfoFromDB.phone, location: userInfoFromDB.location, image: updatedImage };
    setUserInfoFromDB(updatedUser);
  }
  ...
  const handleUpdateUser = e => {
    ...
    formData.append('title', userInfoFromDB.title);
    formData.append('firstName', userInfoFromDB.firstName);
    formData.append('lastName', userInfoFromDB.lastName);
    formData.append('email', user.email);
    formData.append('phone', userInfoFromDB.phone);
    formData.append('location', userInfoFromDB.location);
    formData.append('image', userInfoFromDB.image);
